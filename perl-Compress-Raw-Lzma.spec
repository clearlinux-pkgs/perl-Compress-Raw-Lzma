...
Source0  : https://cpan.metacpan.org/authors/id/P/PM/PMQS/Compress-Raw-Lzma-2.209.tar.gz
...
%prep
%setup -q -n Compress-Raw-Lzma-2.209
cd %{_builddir}/Compress-Raw-Lzma-2.209
pushd ..
cp -a Compress-Raw-Lzma-2.209 buildavx2
popd
