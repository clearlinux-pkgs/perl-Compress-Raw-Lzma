...
Source0  : https://cpan.metacpan.org/authors/id/P/PM/PMQS/Compress-Raw-Lzma-2.092.tar.gz
...
%prep
%setup -q -n Compress-Raw-Lzma-2.092
cd %{_builddir}/Compress-Raw-Lzma-2.092
