...
Source0  : https://cpan.metacpan.org/authors/id/P/PM/PMQS/Compress-Raw-Lzma-2.201.tar.gz
...
%prep
%setup -q -n Compress-Raw-Lzma-2.201
cd %{_builddir}/Compress-Raw-Lzma-2.201
